  ...
  return (
    <div style={{ width: "80%", padding: "30px" }}>
      ...
      <div style={filaStyle}>
        ...
        <Avatar alt='Juan' sx={{ bgcolor: "red" }}>
          J
        </Avatar>
      ...
      <div style={filaStyle}>
        <Chip
          ...
          color='primary'
        />
        <Chip label='¡BIen!' variant='filed' size='medium' color='success' />
      </div>
        ...
        <Card sx={{ maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant='body2' color='text.secondary'>
              Sumérgete en la exuberante selva para encontrarte con la vibrante
              iguana. Maravíllate con su piel brillante y su mirada curiosa
              mientras disfrutas de la diversidad de la fauna en LATAM.
            </Typography>
          </CardContent>
          <CardActions>
        ...
        <Card sx={{ maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant='body2' color='text.secondary'>
              ...
              majestuosa montaña. Admira panoramas impresionantes y siente la
              brisa fresca mientras conquistas nuevas alturas en LATAM.
            </Typography>
          </CardContent>
          <CardActions>
            <Button size='small'>Compartir</Button>
