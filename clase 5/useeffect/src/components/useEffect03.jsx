...
const UseEffect03 = () => {
  ...
  const [apellido, setApellido] = useState("Simonelli");
  ...
  useEffect(() => {
    console.log(
      "useEffect 1- Solo se ejecuta una vez cuando React carga el componente (lo monta)"
    );
    console.log("Componente montado");
  ...
  useEffect(() => {
    console.log("useEffect 3 - Siempre que 'nombre' cambie ");
  }, [nombre]);
